#!/usr/bin/env python3
"""
improve_model_v6b.py — Conservative improvements over V5
Changes:
  1. SAFE price extraction: only fires on explicit MRU/million/prix-labelled
     numbers. Pattern 4 (bare 7-9 digit integers) removed — it was matching
     phone numbers and corrupting the feature.
  2. XGBoost Optuna tuning: 100 trials, same treatment as LGB/CatBoost.
  3. MLP removed from ensemble — too slow for the gain it provides.
  4. LOO target encoding replaces smoothed encoding (more precise, no param).
"""
...
sub_path = os.path.join(OUT_DIR, 'submission_v6b.csv')
